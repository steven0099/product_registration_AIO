...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2024 at 03:10 AM
...
CREATE TABLE `products` (
  ...
  `garansi_elemen_panas_id` int(11) NOT NULL,
  `garansi_motor_id` int(11) UNSIGNED NOT NULL,
  `garansi_panel_id` int(11) UNSIGNED NOT NULL,
  `garansi_semua_service_id` int(11) UNSIGNED NOT NULL,
  `ukuran_id` int(11) UNSIGNED NOT NULL,
