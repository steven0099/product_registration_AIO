...
<script>
    ...
    (category === 'TV' ||
        subcategory === 'SPEAKER' ||
        subcategory === 'COOKER HOOD' ||
        subcategory === 'KIPAS ANGIN' ||
        subcategory === 'AIR CURTAIN')
) {
    queryParams.set('ukuran', capacity); // Set ukuran only for these cases
} else if (capacity) {
    queryParams.set('capacity', capacity); // Set capacity for all other cases
}
    ...
    // Perform AJAX request with the updated query parameters
    $.ajax({
