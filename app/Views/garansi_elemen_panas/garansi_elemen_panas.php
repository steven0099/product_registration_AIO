...
<?= $this->section('title') ?>
Manajemen Garansi Elemen Panas
<?= $this->endSection() ?>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Garansi Elemen Panas</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/#">Home</a></li>
                    <li class="breadcrumb-item active">Garansi Elemen Panas</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <section class="content">
      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
          ...
          <div class="form-group">
              ...
              <input type="number" class="form-control" name="value" placeholder="Garansi Elemen Panas (Tahun)" required>
            </div>
      ...
      <div id="editModal" class="modal">
        <div class="modal-content">
          ...
          <div class="form-group">
              <label for="value">Garansi Elemen Panas (Tahun)</label>
              <input type="number" id="editValue" class="form-control" name="value" placeholder="Garansi Elemen Panas (Tahun)" required>
            </div>
            <button type="submit" class="btn btn-primary">Simpan</button>
          </form>
        </div>
